                            ...
                            {password && (
                                <div className="mt-2 text-xs space-y-1">
                                    ...
                                    <ul className="space-y-1">
                                        <li
                                            className={`flex items-center gap-2 ${password.length >= 12 ? 'text-green-600' : 'text-red-600'
                                                }`}
                                        >
                                        ...
                                        <li
                                            className={`flex items-center gap-2 ${/[^a-zA-Z0-9]/.test(password) ? 'text-green-600' : 'text-red-600'
                                                }`}
                                        >
                                            <span className="w-1 h-1 rounded-full bg-current"></span>
